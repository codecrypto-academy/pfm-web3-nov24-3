export const JEWEL_FACTORY_ABI = [
	{
		"inputs": [
			{
	...
	},
	{
		...
		"name": "JewelFactory__InsufficientMaterialBalance",
		"type": "error"
	},
	{
		"anonymous": false,
	...
	},
	{
		...
		"outputs": [
			...
			},
			{
				...
				"internalType": "struct JewelFactory.MaterialInventory[]",
				"name": "",
				"type": "tuple[]"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct JewelFactory.JewelMetadata",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct JewelFactory.MaterialReceipt",
				"name": "",
				"type": "tuple"
			}
		],
