...
const userJewelsContract = new ethers.Contract(ADDRESS_CONTRACT, USER_ABI, wallet);
...
const createUsers = async () => {
    for (const user of users) {
        try {
            ...
            console.log(`Usuario creado exitosamente. Hash de transacción: ${receipt.hash}`);
            ...
            if (err.info?.error?.data) {
                ...
                const decodedError = new ethers.Interface(USER_ABI).parseError(revertData);
